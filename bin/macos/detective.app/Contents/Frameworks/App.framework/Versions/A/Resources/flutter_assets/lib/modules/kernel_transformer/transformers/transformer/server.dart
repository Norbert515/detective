...
class _FlutterFrontendCompiler implements frontend.CompilerInterface {
  ...
  final DetectiveTransformer detectiveTransformer = DetectiveTransformer();
  ...
  Future<bool> compile(String filename, ArgResults options,
    ...
    if (!transformers.contains(detectiveTransformer)) {
      transformers.add(detectiveTransformer);
    }
